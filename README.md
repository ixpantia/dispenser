...
# wget https://github.com/ixpantia/dispenser/releases/download/vv0.24.0/dispenser-v0.24.0-0-ubuntu-24.x86_64.deb

sudo apt install ./dispenser-v0.24.0-0-ubuntu-24.x86_64.deb
```
...
```sh
# Example for RHEL 9
# wget https://github.com/ixpantia/dispenser/releases/download/vv0.24.0/dispenser-v0.24.0-0.rhel-9.x86_64.rpm

sudo dnf install ./dispenser-v0.24.0-0.rhel-9.x86_64.rpm
```
...
The resulting packages will be named with the OS suffix (e.g., `dispenser-v0.24.0-0-ubuntu-24.x86_64.deb`).
