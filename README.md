...
# wget https://github.com/ixpantia/dispenser/releases/download/v0.20.0/dispenser-0.20.0-0.x86_64.deb

sudo apt install ./dispenser-0.20.0-0.x86_64.deb
```
...
sudo dnf install ./dispenser-0.20.0-0.x86_64.rpm
```
