...
# wget https://github.com/ixpantia/dispenser/releases/download/v0.16.5/dispenser-0.16.5-0.x86_64.deb

sudo apt install ./dispenser-0.16.5-0.x86_64.deb
```
...
sudo dnf install ./dispenser-0.16.5-0.x86_64.rpm
```
