...
# wget https://github.com/ixpantia/dispenser/releases/download/v0.17.1/dispenser-0.17.1-0.x86_64.deb

sudo apt install ./dispenser-0.17.1-0.x86_64.deb
```
...
sudo dnf install ./dispenser-0.17.1-0.x86_64.rpm
```
